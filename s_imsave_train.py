#This iteration of the program is only lacking proper image saving. It saves the images in two big groups, without slider.
...
for epoch in range(start_epoch, input_parameters['num_epochs']):
    ...
    for i in range(num_iters):
        ...
        for trainimage in range(train_im.shape[0]):
            ...
            if (batch_name_batch[trainimage] in namevect) and (epoch % input_parameters['save_step'] == 0) and (args.save_images):
